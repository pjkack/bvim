...
EXCMD(CMD_bnext,	"bnext",	ex_bnext,
	EX_BANG|EX_RANGE|EX_COUNT|EX_CMDARG|EX_TRLBAR,
	ADDR_OTHER),
EXCMD(CMD_borebuildsln,	"borebuildsln",	ex_borebuild,
	EX_BANG|EX_EXTRA,
	ADDR_NONE),
EXCMD(CMD_borebuildproj,	"borebuildproj",ex_borebuild,
	EX_EXTRA,
	ADDR_NONE),
EXCMD(CMD_borebuildprojonly,"borebuildprojonly",ex_borebuild,
	EX_EXTRA,
	ADDR_NONE),
EXCMD(CMD_borebuildfile,	"borebuildfile",ex_borebuild,
	EX_EXTRA,
	ADDR_NONE),
EXCMD(CMD_borebuildinfo,	"borebuildinfo",ex_borebuild,
	0,
	ADDR_NONE),
EXCMD(CMD_boreproj,	"boreproj",	ex_boreproj,
	EX_BANG|EX_WORD1,
	ADDR_NONE),
EXCMD(CMD_boreconfig,	"boreconfig",	ex_boreconfig,
	EX_BANG|EX_WORD1,
	ADDR_NONE),
EXCMD(CMD_borefind,	"borefind",	ex_borefind,
	EX_NEEDARG|EX_EXTRA,
	ADDR_NONE),
EXCMD(CMD_boreopen,	"boreopen",	ex_boreopen,
	EX_WORD1,
	ADDR_NONE),
EXCMD(CMD_boresln,		"boresln",	ex_boresln,
	EX_FILE1,
	ADDR_NONE),
EXCMD(CMD_boretoggle,	"boretoggle",	ex_boretoggle,
	EX_WORD1,
	ADDR_NONE),
...
EXCMD(CMD_cwindow,	"cwindow",	ex_cwindow,
	EX_RANGE|EX_COUNT|EX_TRLBAR,
	ADDR_OTHER),
EXCMD(CMD_ctoggle,		"ctoggle",	ex_ctoggle,
	EX_RANGE|EX_COUNT|EX_TRLBAR,
	ADDR_LINES),
...
EXCMD(CMD_lwindow,	"lwindow",	ex_cwindow,
	EX_RANGE|EX_COUNT|EX_TRLBAR,
	ADDR_OTHER),
EXCMD(CMD_ltoggle,		"ltoggle",	ex_ctoggle,
	EX_RANGE|EX_COUNT|EX_TRLBAR,
	ADDR_LINES),
...
EXCMD(CMD_X,		"X",		ex_X,
	EX_TRLBAR,
	ADDR_NONE),
EXCMD(CMD_Boreopenselection,	"ZZBoreopenselection",	ex_Boreopenselection,
	0,
	ADDR_NONE),
